...
def validate_html(html):
    ...
    checking whether each opening tag has a corresponding closing tag.
    ...
    # tags without any extra text then process these html tags using
    # the balanced parentheses algorithm from the class/book the main
    # difference between your code and the code from class will
